...
{
    public class GetAdminRecentBookingsHandler : IRequestHandler<GetAdminRecentBookingsQuery, List<RecentBookingDto>>
    {
        private readonly IRecentBookingRepository _repository;

        public GetAdminRecentBookingsHandler(IRecentBookingRepository repository)
        {
            _repository = repository;
        }

        public async Task<List<RecentBookingDto>> Handle( GetAdminRecentBookingsQuery request, CancellationToken cancellationToken)
        {
